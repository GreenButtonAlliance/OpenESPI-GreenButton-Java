 ...
 * 
 * Tables included:
 * - service_delivery_points (extends Object - vendor-specific auto-increment)
 ...
 * - pnode_refs (extends Object - vendor-specific auto-increment, FK to usage_points)
 * - aggregated_node_refs (extends Object - vendor-specific auto-increment, FK to usage_points)
 ...
 * - interval_readings (extends Object - vendor-specific auto-increment, FK to interval_blocks)
 * - reading_qualities (extends Object - vendor-specific auto-increment, FK to interval_readings)
 * - usage_summaries (FK dependency on usage_points, must precede line_items)
 * - usage_summary_related_links (FK dependency)
 * - line_items (extends Object - vendor-specific auto-increment, FK to usage_summaries)
 *
...
(
    ...
    INDEX idx_line_item_usage_summary (usage_summary_id),

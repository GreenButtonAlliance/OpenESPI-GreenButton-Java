...
@DisplayName("ReadingTypeExportService Namespace Tests")
class ReadingTypeExportServiceTest {

    private ReadingTypeExportService readingTypeExportService;

    @BeforeEach
    void setUp() {
        readingTypeExportService = new ReadingTypeExportService();
        readingTypeExportService.init();
    }
    ...
    void shouldDeclareEspiNamespaceOnly() {
        // Arrange
        ReadingTypeDto readingType = new ReadingTypeDto();
        ...
        readingTypeExportService.exportDto(entry, stream);
        ...
        // Assert - ReadingType content with espi prefix
        assertThat(xml)
            .as("ReadingType should use espi prefix")
            .contains("<espi:ReadingType");
    }
}

...
/**
 * Statement entity integration tests using MySQL TestContainer.
 *
 * Tests Phase 19 ESPI 4.0 compliance with MySQL:
 ...
 * - Full CRUD operations with real MySQL database
 */
@DisplayName("Statement Integration Tests - MySQL")
@ActiveProfiles({"test", "test-mysql"})
class StatementMySQLIntegrationTest extends BaseTestContainersTest {
    ...
    void shouldPersistStatementWithElementCollection() {
        ...
        statement.setDescription("MySQL Statement Test");

...
import org.greenbuttonalliance.espi.datacustodian.authserver.service.DataCustodianIntegrationService;
import org.greenbuttonalliance.espi.datacustodian.authserver.service.DataCustodianIntegrationService.*;
...
public class DataCustodianIntegrationController {
    ...
    public ResponseEntity<?> verifyUser(@Valid @RequestBody UserVerificationRequest request) {
        ...
        try {
            DataCustodianIntegrationService.UserVerificationResult result = integrationService.verifyUser(
